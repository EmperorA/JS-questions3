...
for (i = 0; i < 100; i++){
 ...
 arr.push(Math.floor(Math.random(i) * 101))
}
arr.length = 10;
console.log(arr)
}
...
function maxNum(values) {
  ...
  for (i = 0; i < values.length; i++){
    year.push(parseInt(values[i].Year));
  }
  let maxNum = year.reduce((prev, current) => {
...
function moviesLength(values){              
let types = [];
for (i = 0; i < values.length; i++){
             
            if (values[i].Type == "movie"){
                types.push(values[i].Type);
}
  }
...
function milleniumMovies(values){
...
for (i = 0; i < values.length; i++){
            ...
            if (values[i].Year > mil){
                 milMovies.push(values[i].Title);
               
            }
              }
               console.log(milMovies);

}
milleniumMovies(movies);
...
function imdb(values){

const id = "tt0355702";
for (i = 0; i < values.length; i++){
           
            
            if (values[i].imdbID == id){
      console.log(values[i].Title);
...
function sumYears(values){

sum = 0;
for (i = 0; i < values.length; i++){
          sum += parseInt(values[i].Year) 
            }
            console.log(sum)
}
sumYears(movies);
...
titles = [];
for (i = 0; i < values.length; i++){
          if (values[i].Title == "provided below"){
              titles.push(values[i].Title);
          }
            }
            console.log(titles)
